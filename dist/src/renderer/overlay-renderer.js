 ...
 */
async function getLocalFontBase64(fontFamily, fontWeight = 400) {
 ...
 */
async function generateOverlayHTML(payload) {
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .caption {
      ...
      font-size: ${style.fontSize * 0.50}px;
 ...
 */
export async function renderCaptionOverlays(browser, payload, totalFrames, duration, fps, outputDir) {
